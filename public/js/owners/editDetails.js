$(document).ready(function() {
    ...
    $('#cancelButton').click(function() {
        ...
        $('.text-secondary input').each(function() {
            var originalText = $(this).attr('data-original'); // Retrieve the original text stored as data attribute
            $(this).closest('.text-secondary').text(originalText);
        });
    ...
    $('#saveButton').click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'http://localhost/SeamlessBus/Owners/profile', // Replace with your server-side script URL to handle the update
