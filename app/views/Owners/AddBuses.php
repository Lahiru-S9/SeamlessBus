...
<div class="container">
    ...
    <div class="content">
        ...
        <form action="<?php echo URLROOT; ?>/Owners/AddBuses" method="POST">
            ...
            <div class="form-group">
                <label for="bus_seat">No of Bus Seat: <sup>*</sup></label>
            ...
            <div class="form-group">
                <label for="bus_owner">Bus Owner: <sup>*</sup></label>
                <input type="text" class="custom-input <?php echo (!empty($data['bus_owner_err'])) ? 'is-invalid' : ''; ?>" name="bus_owner" value="<?php echo $data['bus_owner']; ?>">
