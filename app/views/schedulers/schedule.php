...
<!--1 button image -->
        ...
        <a href="/app/views/schedulers/AddRoots.php"> 
        <img src="<?php echo URLROOT;?> /public/img/verify conductors.png" class="image"></a>
        </div>
<!-- 1 end button image -->
<!-- 2 end button image -->
        <div class="clickheres">
        <a href="/app/views/schedulers/DefineSchedule.php"> 
...
<!-- 2 end button image -->
<div class="clickheres">
        <a href="/app/views/schedulers/seeRoots.php"> 
        <img src="<?php echo URLROOT;?>/public/img/SeeConductor.png"  class="image"></a>
        </div>
 ...
 <!-- 2 end button image -->
 <div class="clickheres">
        <a href="/app/views/schedulers/manageSchedule.php"> 
        <img src="<?php echo URLROOT;?>/public/img/SeeConductor.png"  class="image"></a>
        </div>
