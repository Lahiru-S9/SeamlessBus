    ...
    <div class="card-user-select">
        ...
        <div class="card-body-user-select">
            <div class="form-group-user-select">
                <button onclick="window.location.href = '<?php echo URLROOT; ?>/users/register';" class="btn btn-primary btn-user-select btn-block">Registered Passenger</button>
            </div>
            <div class="form-group-user-select">
            ...
            <div class="form-group-user-select">
                <button onclick="window.location.href = '<?php echo URLROOT; ?>/users/register';" class="btn btn-primary btn-user-select btn-block">Owner</button>
            </div>
        </div>
    </div>
</div>
